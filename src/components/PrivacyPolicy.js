            ...
            <footer className="container-xxl footer">
                <div className="row">
                    <div className="col-xl-5">
                        <p className="footer-text"><span className="copy-text">Vteam LIMS © {new Date().getFullYear()}</span> <a href="/privacy-policy" className="" target="_blank">Գաղտնիության քաղաքականություն</a></p>
                    </div>
